...
namespace eval DemoPackage3 {
    namespace export demoPackage3
    proc demoPackage3 {} {
	puts "DemoPackage3"
    }
}

puts "File 'DemoPackage3'"

source demopackage4.tcl
namespace import ::DemoPackage4::*
demoPackage4
DemoPackage3::demoPackage3
namespace import ::DemoPackage3::*
demoPackage3
